...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    'menu-scale-desc':     '太陽系の天体の大きさを並べて比較',
    ...
    'locate-btn':          '現在地',
    'locate-btn-busy':     '取得中…',
    'locate-error':        '現在地を取得できませんでした。位置情報の使用が許可されているか確認してください。',
    'label-jupiter':       '木星',
    'label-saturn':        '土星',
    'label-uranus':        '天王星',
    'label-neptune':       '海王星',
  ...
  en: {
    ...
    'menu-scale-desc':     'Compare the sizes of Solar System bodies side by side',
    ...
    'label-venus':         'Venus',
    'label-mars':          'Mars',
    'locate-btn':          'My location',
    'locate-btn-busy':     'Locating…',
    'locate-error':        'Could not get your location. Please check that location access is allowed.',
    'label-jupiter':       'Jupiter',
    'label-saturn':        'Saturn',
    'label-uranus':        'Uranus',
    'label-neptune':       'Neptune',
    'label-pluto':         'Pluto',
    'size-dwarf-note':     ' (dwarf planet)',
    'size-view-all':       'View all',
    'size-focus':          'Zoom to {name}',
  },
}
